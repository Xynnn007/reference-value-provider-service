...
use self::extractor_modules::{ExtractorModuleList, ExtractorInstance};

/// The key in `parameters` HashMap of `handle_provenance()`, which 
/// indicates current workdir for the Extractor.
...
mod test {
    ...
    use super::{Extrators, WORKING_DIR_KEY, ExtratorsAPI};
